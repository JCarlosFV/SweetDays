...
public class Cliente{
    ...
    private List<Postre> pedidos;

    public Cliente(String id, String nombre, String apellido, String telefono, String correo, String direccion, Date fechNac) {
        this.setId(id);
        ...
        this.pedidos = new ArrayList<Postre>();
    }
    ...
    public void nuevo_pedido (Postre producto, int cantidad){
